...
class Node():
    ...
    # First test if the node is the terminal node, if not then expand. Or else chose a random node as the next node.
    ...
    def best_child(self, c_param=0.1):
        ...
        if order == 1:  # player first then chose the biggest node as the best node
